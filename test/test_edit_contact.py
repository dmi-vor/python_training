...
def test_edit_contact(app):
    app.contact.edit_first_contact(Contact(firstname="modСтепан", middlename="modДядя Степа", lastname="modСтепанов", nickname="modКаланча", title="modБывший флотский старшина", company="modЗастава Ильича", address="modДом 8/1 у заставы Ильича", home="mod+7001001001", mobile="mod+7002002002",
