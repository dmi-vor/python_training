...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="Степан", middlename="Дядя Степа", lastname="Степанов", nickname="Каланча", title="Бывший флотский старшина", company="Застава Ильича", address="Дом 8/1 у заставы Ильича", home="+7001001001", mobile="+7002002002",
